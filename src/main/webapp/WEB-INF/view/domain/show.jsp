    ...
    <body>
        <div class="container">
            ...
            <ul class="nav nav-tabs justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/analyze/domain"><i class="fas fa-globe"></i> Domain</a>
                </li>
            </ul>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header text-center">
                            <h4><i class="fas fa-globe"></i> Analyze Domain</h4>
                        </div>
                        <div class="card-body">
                            <form action="/analyze/domain" method="post">
                                <div class="form-group">
                                    <label for="target">Enter Domain:</label>
